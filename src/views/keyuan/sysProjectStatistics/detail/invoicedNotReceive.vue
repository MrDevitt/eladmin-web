  ...
  <div class="app-container">
    <el-card class="box-card" shadow="always">
      ...
      <el-table :data="shouldReceiveData" show-summary stripe>
        ...
        <el-table-column prop="amount" label="已开票未收款金额" />
        />
      </el-table>
    </el-card>
    <el-card class="box-card" shadow="always">
      <div slot="header" class="card-header">
        <span>已开票未收款项目明细</span>
      </div>
      <div class="head-container">
        ...
        >
          ...
          <el-table-column prop="invoiceNotReceiveAmount" label="已开票未收款金额" :formatter="formatPrice" />
...
import { getInvoicedNotReceiveData } from '@/api/keyuan/sysProjectStatistics'
...
export default {
  ...
  cruds() {
    return CRUD({
      title: '项目明细',
      url: 'api/sysProjectDetail/invoicedNotReceive',
      idField: 'id',
      // sort: 'invoiceNotReceiveAmount,desc',
  ...
  async created() {
    ...
    getInvoicedNotReceiveData().then(res => {
      this.shouldReceiveData = res.rows.slice()
    })
  },
  methods: {
